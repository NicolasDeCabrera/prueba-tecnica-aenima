                ...
                <MenuMobile>
                    <DivCruzMenu>
                        ...
                        <Contenedor flex column px="40px" gap="18px">
                            ...
                            <Link activeClass="active" to="Tendencias" spy={true} smooth={false} offset={-400} duration={0} delay={0} onClick={()=>{menuDesktopSeleccionado("tendencias","mobile")}}><EnlaceMenuMobile>TENDENCIAS</EnlaceMenuMobile></Link>
